...
public class GroovyScript implements Script {
	...
	public GroovyScript(String id, String source) {
		super();
		this.id = id;
		this.source = source;
	}
	...
	/* (non-Javadoc)
	 * @see hudson.drools.Script#execute(org.drools.runtime.StatefulKnowledgeSession, java.io.PrintWriter, java.util.Map)
	 */
